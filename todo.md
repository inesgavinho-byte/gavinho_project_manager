...
## Secção de Competências no Perfil

- [x] Criar tabela userSkills no schema
- [x] Executar migration para userSkills
- [x] Criar userSkillsDb.ts com funções CRUD
- [x] Criar userSkillsRouter.ts com endpoints tRPC
- [x] Integrar userSkillsRouter no routers.ts
- [x] Criar componente SkillsManager.tsx
- [x] Criar componente AddSkillDialog.tsx
- [x] Criar componente EditSkillDialog.tsx
- [x] Criar componente SkillCard.tsx
- [x] Integrar SkillsManager na página UserProfile.tsx
- [x] Adicionar aba "Competências" nos tabs
- [ ] Escrever testes para userSkillsDb
- [ ] Testar fluxo completo de adicionar/editar/eliminar competências
