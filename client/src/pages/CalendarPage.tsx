            ...
            <div className="flex items-center gap-1 bg-white border border-gray-200 rounded-lg p-1">
              <button
                ...
                className={`px-4 py-2 rounded-md text-sm font-medium transition-colors ${
                  viewMode === "month" ? "bg-[#C9A882] text-white" : "text-gray-600 hover:bg-gray-100"
                }`}
              >
                Mês
              </button>
              <button
                ...
                className={`px-4 py-2 rounded-md text-sm font-medium transition-colors ${
                  viewMode === "week" ? "bg-[#C9A882] text-white" : "text-gray-600 hover:bg-gray-100"
                }`}
              >
                Semana
              </button>
              <button
                ...
                className={`px-4 py-2 rounded-md text-sm font-medium transition-colors ${
                  viewMode === "day" ? "bg-[#C9A882] text-white" : "text-gray-600 hover:bg-gray-100"
                }`}
              >
                Dia
              </button>
        ...
        {viewMode === "week" && (
          <div className="bg-white rounded-lg p-6 border border-gray-200">
            <div className="text-center py-12">
              <h3 className="text-xl font-semibold mb-2" style={{ color: "#5F5C59" }}>
                Visualização Semanal
              </h3>
              <p className="text-gray-600">Em desenvolvimento - Utilize a visualização mensal</p>
            </div>
          </div>
        )}
